            ...
            <div className="max-w-xl mx-auto">
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <label className="form-control">
                        ...
                        <textarea defaultValue={recipe} {...register('recipe', {required: true})} className="textarea textarea-bordered h-24 mb-4" placeholder="Recipe details"></textarea>
                    </label>
                    {/* file */}
                    <input type="file" {...register('image', {required: true})} className="file-input w-full max-w-xs mb-4" />
                    <br />
                    <button className="btn bg-[#D1A054] border-none text-white font-semibold ">Update Item</button>
